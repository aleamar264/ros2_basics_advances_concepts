...
{
  public:
    TurtleController() : Node("turltle_controller")
    {
        ...
        spawn_turtle_client_ =
            this->create_client<turtlesim::srv::Spawn>("/spawn", rmw_qos_profile_services_default, cb_group_);
        kill_turtle_client_ =
            this->create_client<turtlesim::srv::Kill>("/kill", rmw_qos_profile_services_default, cb_group_);
